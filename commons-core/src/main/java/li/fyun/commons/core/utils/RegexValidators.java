...
public final class RegexValidators {
     ...
     * 正则表达式：验证用户名
     */
    public static final String REGEX_USERNAME = "^[a-zA-Z0-9]\\w{2,30}$";

    /**
     * 正则表达式：验证密码，// 长度6-20位
     */
    public static final String REGEX_PASSWORD = "^((?=.*\\d)(?=.*[a-z])(?=.*[A-Z]).{5,30})$";

    /**
     * 正则表达式：验证手机号
     */
    public static final String REGEX_MOBILE = "^([0]{0,2}86)?(1[3-9][0-9]{9})$";
    ...
    public static final String REGEX_PERSON_NAME = "^([a-zA-Z0-9]+([(\\u2022)-. ]?\\w){0,199}|([(\\u4e00-\\u9fa5)|\\u2022]{2,200}))$";
