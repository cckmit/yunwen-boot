...
public class TransparentPngCaptcha extends Captcha {

    public TransparentPngCaptcha() {
    }

    public TransparentPngCaptcha(int width, int height) {
        this();
        setWidth(width);
        setHeight(height);
    }

    public TransparentPngCaptcha(int width, int height, int len) {
        this(width, height);
        setLen(len);
    }

    public TransparentPngCaptcha(int width, int height, int len, Font font) {
